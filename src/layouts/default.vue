<template>
  <v-app>
    <v-app-bar app color="pink lighten-2" dark elevation="1">
    ...
    <v-navigation-drawer app v-model="sidebar" :mini-variant.sync="mini">
      <v-list dense color="pink lighten-2" dark>
        <v-list-item>
          <v-list-item-action>
      ...
      <v-list-item class= "px-2" @click="mini=!mini">
        ...
        <v-list-item-content>Manuela Santos</v-list-item-content>
    ...
    <v-footer app color="pink lighten-2" class="py-3" dark><span class="caption">MyToDoList &copy;2021</span></v-footer>
  </v-app>
</template>
